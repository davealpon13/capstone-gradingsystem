...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
       ...
       $updateQuery = "UPDATE lab_midterm SET 
...
<form action="" method="post">
    ...
    <label for="total_attendance_participation">Attendance and Partcipation:</label>
    <input type="text" name="total_attendance_participation" value="<?php echo $row['total_attendance_participation']; ?>">
   
    <label for="weighted_attendance_participation">Weighted Attendance and Partcipation 20%:</label>
