...
<head>
    <meta charset="utf-8">
    <title>Edit  Midterm Record</title>
    <style>
        body {
...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $newMidterm = mysqli_real_escape_string($conn, $_POST['midterm_score']);
        $weightedMidterm = mysqli_real_escape_string($conn, $_POST['weighted_midterm']);

    

// Update the query with the new fields and values
$updateQuery = "UPDATE midterm SET 
    ...
    weighted_midterm = '$weightedMidterm'
    WHERE id = '$id'";
...
<form action="" method="post">
    ...
    <label for="weighted_attendances">Weighted Attendance Days 10%:</label>
    ...
    <input type="text" name="midterm_score" value="<?php echo $row['midterm_score']; ?>">

    <label for="weighted_midterm">Weighted Midterm Score 20%:</label>
    <input type="text" name="weighted_midterm" value="<?php echo $row['weighted_midterm']; ?>">
